...
| ✅ L9 | `snippets/cart-hero.liquid:5` | UX | "Continue shopping" → `routes.all_products_collection_url` (/collections/all) |
| — L10 | `snippets/cart-summary.liquid` | UX | Trust signalok — kihagyva (nincs tartalom hozzá) |
